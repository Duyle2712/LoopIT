...
<!-- Owl Stylesheets -->
<link rel="stylesheet" href="{{ URL::asset('resources/css/owlcarousel/owl.carousel.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('resources/css/owlcarousel/owl.theme.default.min.css') }}">
<!-- main css -->
